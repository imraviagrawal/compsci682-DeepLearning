...
class TwoLayerNet(object):
  ...
  """
    ...
    """
        h1, fc1_cache = affine_forward(X, self.params["W1"], self.params["b1"])
        h1, fc1_relu_cache = relu_forward(h1)
        h2, fc2_cache = affine_forward(h1, self.params["W2"], self.params["b2"])
        scores = h2
        ############################################################################
        ...
        # backward pass
        dx, grads["W2"], grads["b2"] = affine_backward(dScore, fc2_cache)
        grads["W2"] += self.reg * self.params["W2"]
        dx, grads["W1"], grads["b1"] = affine_relu_backward(dx, (fc1_cache, fc1_relu_cache))
